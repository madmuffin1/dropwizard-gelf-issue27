...
public class ApplicationWithoutGelfLoggingWorks {

    @ClassRule
    public static final DropwizardAppRule<SampleConfiguration> APP_RULE = new DropwizardAppRule<>(WorkingApplication.class, ResourceHelpers.resourceFilePath("config.yml"));
